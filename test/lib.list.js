  ...
  it("should be able to retreive a list for each category", () => {
    ...
    const fetchCategory = (category) =>
      gplay
        ...
        .catch(() => {
          // Some categories may temporarily fail due to Google Play changes.
          // WATCH_FACE and MEDICAL are known to fail; log others for awareness
          // but don't fail the test - Google's store structure changes over time.
        });
